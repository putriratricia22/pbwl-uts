...
<body>
      ...
      <aside>
            ...
            <header>
                  ...
                  <div class="user">KOST MUSLIMAH</div>
                  <div class="user">Putri Ratricia</div>
            </header>
            ...
            <nav>
                  <ul>
                        ...
                        <li>
                              ...
                              <img class="icon" src="layouts/assets/img/logout.png" alt=""> Keluar
                              </a>
                        </li>
                  </ul>
            </nav>
      ...
      <main>
            ...
            <footer>
                  Copyright &copy; 2023. Putri Ratricia
            </footer>
      </main>
